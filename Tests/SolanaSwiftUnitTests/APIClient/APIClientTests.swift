...
//        XCTAssert(result[0].pubkey == "57UtuDwoCurTTWySMeV5MiopvDWvK2QeLWu47biQjjLJ")
    ...
    func testGetFeeForMessage() async throws {
        ...
        let result = try! await apiClient.getFeeForMessage(message: "", commitment: "processed")
        XCTAssertNotNil(result)
...
private var NetworkManagerMockJSON = [
    ...
    "getFeeForMessage": "{\"jsonrpc\":\"2.0\",\"result\":{\"context\":{\"slot\":131770081},\"value\": 30000},\"id\":\"1\"}\n",
    "getMinimumBalanceForRentExemption": "{\"jsonrpc\":\"2.0\",\"result\":890880,\"id\":\"25423C5F-2FF3-4134-8CB3-9090BFCB2CE3\"}\n",
    "getLatestBlockhash": "{\"jsonrpc\":\"2.0\",\"result\":{\"context\":{\"apiVersion\":\"2.0.14\",\"slot\":336852026},\"value\":{\"blockhash\":\"63ionHTAM94KaSujUCg23hfg7TLharchq5BYXdLGqia1\",\"lastValidBlockHeight\":325051333}},\"id\":1}",
